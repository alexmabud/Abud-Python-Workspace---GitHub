...
# === 1. Lê as colunas X (Data) e AS (Total) da planilha ===
...
# === 3. Corrige datas com ano errado (2024 → 2025) ===
...
# === 4. Converte valores de saída para número e preenche vazios com 0 ===
df_raw['Saida'] = pd.to_numeric(df_raw['Saida'], errors='coerce').fillna(0)

# === 5. Remove as linhas que representam totais do mês (Data nula) ===
df_saida = df_raw[df_raw['Data'].notna()].copy()

# === 6. Salva CSV corrigido ===
...
# === 11. Exibe os resultados formatados ===
